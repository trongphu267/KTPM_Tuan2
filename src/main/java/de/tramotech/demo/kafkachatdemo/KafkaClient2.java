...
public class KafkaClient2 {
    ...
    private static final String GROUP_ID2 = getProperty("user", "Chac co");
    private static KafkaClient2 INSTANCE = null;
    private final Consumer<String, String> consumer;
    private final KafkaProducer<String, String> producer;

    private KafkaClient2() {
    ...
    public void sendMessage(String msg) {
        ProducerRecord<String, String> prducerRecord = new ProducerRecord<>(TOPIC, GROUP_ID2, msg);
    ...
    static KafkaClient2 getInstance() {
        if(INSTANCE == null) {
            INSTANCE = new KafkaClient2();
        }
        return INSTANCE;
    }
